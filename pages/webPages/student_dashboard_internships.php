...
<?php include '../../php/connection.php';?>
          ...
          <div class="card-text text-left">
            ...
            <div class="row">
               ...
               <div class="text-right col-sm-6">
                 <form class="" action="php/removeintern.php" method="post">
    ...
    <?php } ?>
    <div class="text-center">Apply for<span class="text-primary" style="cursor:pointer;" onclick="loadDoc('content','pages/webPages/internlist.php')"> new internship</span></div>
    </div>
